...
<form method="post">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="contactp" class="form-control" id="c" placeholder="Password" value="<?php echo $row[6];?>"maxlength="11" placeholder="Phone Number Should be like 03xxxxxxxxx" pattern="03[0-9]{2}(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" required title="Phone Number Should be like 03xxxxxxxxx">
    </div>
  </div> 
  ...
  <div class="form-group row">
    <div class="col-sm-12">
      <button type="submit" class="btn btn-primary form-control" name="btnSubmit" >Update Record</button>
    </div>
  </div>
</form>